...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        weigths_dim = [(num_filters, C, filter_size, filter_size),(HP*WP*num_filters, hidden_dim),(hidden_dim, num_classes)]
        biases_dim = [num_filters, hidden_dim, num_classes]

        # Initialize weights and biases
        for i in range(1,4):
            self.params['W%d' %i] = np.random.normal(loc=0.0, scale=weight_scale,size=weigths_dim[i-1])
